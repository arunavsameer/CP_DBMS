...
function UserAnalytics({ handle }) {
  ...
  useEffect(() => {
    if (!handle) return; // Skip fetch if handle is empty
    ...
    const fetchCodeforcesData = async () => {
      try {
        ...
        const ratingHistoryResponse = await fetch(`https://codeforces.com/api/user.rating?handle=${handle}`);
